 ...
 *
 */
public class LargerFontSizeAction extends AbstractAction
{
  MainFrameController mainFrameController;
  JustWriteMainFrame mainFrame;
  
  public LargerFontSizeAction(MainFrameController mainFrameController, JustWriteMainFrame mainFrame, String name, Integer mnemonic)
  {
    super(name, null);
  ...
  {
    mainFrameController.doLargerFontSizeAction();
  }
}
