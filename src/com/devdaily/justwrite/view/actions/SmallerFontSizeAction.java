 ...
 *
 */
public class SmallerFontSizeAction extends AbstractAction
{
  MainFrameController mainFrameController;
  JustWriteMainFrame mainFrame;
  
  public SmallerFontSizeAction(MainFrameController mainFrameController, JustWriteMainFrame mainFrame, String name, Integer mnemonic)
  {
    super(name, null);
  ...
  {
    mainFrameController.doSmallerFontSizeAction();
  }
}
