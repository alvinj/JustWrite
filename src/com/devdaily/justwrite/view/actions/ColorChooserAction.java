...
public class ColorChooserAction extends AbstractAction
{
  ...
  public ColorChooserAction(MainFrameController mainFrameController, JustWriteMainFrame mainFrame, String name, Integer mnemonic)
  {
    super(name, null);
  ...
  {
    mainFrameController.doChooseColorAction();
  }
}
