...
public class CloseFileAction extends AbstractAction
{
  ...
  public CloseFileAction(MainFrameController mainFrameController, JustWriteMainFrame mainFrame, String name, Integer mnemonic)
  {
    super(name, null);
  ...
  {
    // hand all this off to the mainFrameController
    mainFrameController.doCloseCurrentFileAction();
  }
}
