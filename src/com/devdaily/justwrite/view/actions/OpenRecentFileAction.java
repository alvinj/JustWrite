...
public class OpenRecentFileAction extends AbstractAction
{
  ...
  public OpenRecentFileAction(MainFrameController mainFrameController, JustWriteMainFrame mainFrame, String name, Integer mnemonic)
  {
    super(name, null);
  ...
  {
    mainFrameController.doOpenRecentFileAction();
  }
}
